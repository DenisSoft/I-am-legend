...
export class BonusesSet extends ObjectsSet {
    ...
    static isHeroCatchBonus(bonus, hero) {
    ...
    checkStatus(hero) {
        this.data.forEach((bonus) => {
            if (BonusesSet.isHeroCatchBonus(bonus, hero)) {
                if (bonus.item === 'kunai') {
...
export class KunaiSet extends ObjectsSet {
    ...
    static isKunaiInZombie(kunai, zombie) {
        if(!zombie.isLeft) {
    ...
    static isKunaiInBossZombie(kunai, boss, hero) {
    ...
    checkStatus(zombiesArr, boss, hero, game) {
        this.data.forEach((kunai) => {
            if(KunaiSet.isKunaiInBossZombie(kunai, boss, hero)) {
            ...
            zombiesArr.data.forEach((zombie) => {
                if (KunaiSet.isKunaiInZombie(kunai, zombie) && !zombie.fakeDead
